        ...
        public static void Run(Options o)
        {
            try
            {
                ...
                if (o.AssetExportType == ExportType.Prefab)
                {
                    ...
                    TypeFlags.SetType(ClassIDType.Mesh, true, false);
                    TypeFlags.SetType(ClassIDType.ParticleSystemRenderer, true, false);
                }
                ...
                if (o.MapOp.HasFlag(MapOpType.CABMap) || o.CabMapPath != null)
                {
                    if (o.MapOp.HasFlag(MapOpType.Load) || o.CabMapPath != null)
                    {
                ...
                if (o.MapOp.HasFlag(MapOpType.AssetMap))
                {
                    if (o.MapOp.HasFlag(MapOpType.Load))
                    {
                        ...
                        var mapTypeFilter = o.AssetExportType == ExportType.Prefab
                            ...
                            : classTypeFilter;
                        files = AssetsHelper.ParseAssetMap(assetMapPath, o.MapType, mapTypeFilter, o.NameFilter, o.ContainerFilter, inputRoot, sourceFilter);
                    }
                    else if (o.MapShardSize > 0)
                    {
                        Task.Run(() => AssetsHelper.BuildAssetMapSharded(files, o.MapName, game, o.Output.FullName, o.MapType, o.MapShardSize, classTypeFilter, o.NameFilter, o.ContainerFilter)).Wait();
                    }
                    else
                    {
