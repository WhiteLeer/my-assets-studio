...
namespace AnimeStudio
{
    public static class GameManager
    {
        ...
        {
            Games.Clear();
            // This branch intentionally exposes only the live ZZZ 3.0 profile.
            Games.Add(0, new Mhy(GameType.ZZZ, "Zenless Zone Zero 3.0", GIMhyShiftRow, GIMhyKey, GIMhyMul, null, GISBox, null, 0uL));
        }
