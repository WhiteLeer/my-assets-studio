...
namespace AnimeStudio
{
    public static class TypeTreeHelper
    {
        ...
        // Read a contiguous TypeTree slice from the reader's current position.
            // Game serializers can extend Unity component layouts beyond the engine
            // defaults, so the normal whole-object reader
        // becomes offset after that point. The remaining stock nodes are still
        // useful when started at the first field after a game-specific prefix.
